  ...
  public: {
    Tables: {
      account_blocks: {
        ...
        Relationships: [
          {
            foreignKeyName: "account_blocks_blocked_id_fkey"
            columns: ["blocked_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "account_blocks_blocker_id_fkey"
            columns: ["blocker_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
      ...
      account_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "account_reports_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "account_reports_reported_id_fkey"
            columns: ["reported_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "account_reports_reporter_id_fkey"
            columns: ["reporter_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "account_reports_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
      ...
      booking_proof_media: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "booking_proof_media_worker_id_fkey"
            columns: ["worker_id"]
            isOneToOne: false
      ...
      customer_verifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "customer_verifications_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
      ...
      live_dispatch_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "live_dispatch_sessions_service_request_id_fkey"
            columns: ["service_request_id"]
            isOneToOne: true
            referencedRelation: "service_requests"
            referencedColumns: ["id"]
      ...
      service_request_dispatches: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "service_request_dispatches_worker_id_fkey"
            columns: ["worker_id"]
            isOneToOne: false
            referencedRelation: "worker_profiles"
            referencedColumns: ["account_id"]
      ...
      service_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "service_requests_subdivision_id_fkey"
      ...
      user_profiles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "user_profiles_subdivision_id_fkey"
            columns: ["subdivision_id"]
            isOneToOne: false
            referencedRelation: "subdivisions"
            referencedColumns: ["id"]
      ...
      worker_profiles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "worker_profiles_subdivision_id_fkey"
            columns: ["subdivision_id"]
            isOneToOne: false
            referencedRelation: "subdivisions"
            referencedColumns: ["id"]
      ...
      worker_recommendation_subscriptions: {
        Row: {
          amount: number
          created_at: string
          duration_days: number
        ...
        Relationships: [
          {
            foreignKeyName: "worker_recommendation_subscriptions_plan_id_fkey"
            columns: ["plan_id"]
            isOneToOne: false
            referencedRelation: "worker_recommendation_plans"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "worker_recommendation_subscriptions_worker_id_fkey"
            columns: ["worker_id"]
            isOneToOne: false
            referencedRelation: "worker_profiles"
            referencedColumns: ["account_id"]
    ...
    Functions: {
      admin_activate_subscription: {
        ...
        SetofOptions: {
          from: "*"
          to: "worker_recommendation_subscriptions"
          isOneToOne: true
          isSetofReturn: false
        }
      }
      admin_activate_verified_worker: {
      ...
      admin_review_customer_verification: {
        Args: {
          p_decision: string
          p_notes?: string
      ...
      admin_upsert_subscription_plan: {
        ...
        SetofOptions: {
          from: "*"
          to: "worker_recommendation_plans"
          isOneToOne: true
          isSetofReturn: false
        }
      }
      ...
      generate_matches_weighted_core: {
        Args: { p_service_request_id: string }
        Returns: {
          created_at: string
          eligible: boolean
      ...
      report_booking_participant: {
        Args: { p_booking_id: string; p_details: string; p_reason_code: string }
        Returns: {
          booking_id: string | null
          created_at: string
          details: string
      ...
      set_my_preferred_locale: { Args: { p_locale: string }; Returns: string }
      set_my_subdivision: {
        Args: { p_subdivision_id: string }
        Returns: string
      }
      ...
      submit_customer_verification: {
        Args: { p_back_url?: string; p_front_url: string; p_id_type: string }
        Returns: {
          created_at: string
          customer_id: string
          id: string
