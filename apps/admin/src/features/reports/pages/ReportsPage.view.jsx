  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        ...
        >
          <div
            className={`p-3 rounded-full mb-3 ${reportType === 'All' ? 'bg-gray-700 text-white' : 'bg-gray-100 text-gray-600'}`}
          >
            <Filter size={24} />
          </div>
        ...
        {[
          ...
          return (
            ...
            >
              <div
                className={`p-3 rounded-full mb-3 ${isActive ? 'bg-white/20 text-white' : type.bg + ' ' + type.color}`}
              >
                {type.icon}
              </div>
                ...
                <tr key={report.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="p-2 rounded-lg bg-gray-50 mr-3">{report.icon}</div>
                      <div>
