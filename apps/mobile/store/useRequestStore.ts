...
type RequestDraft={categoryId:string;description:string;addressId:string|null;address:string;addressDetails:Record<string,any>|null;coords:{latitude:number;longitude:number}|null;media:MediaInput[];aiConsent:boolean;aiJobId:string|null;aiResult:Record<string,any>|null;requestId:string|null;bookingId:string|null;searchRadiusKm:number;scheduledAt:string|null};
const initial:RequestDraft={categoryId:'',description:'',addressId:null,address:'',addressDetails:null,coords:null,media:[],aiConsent:false,aiJobId:null,aiResult:null,requestId:null,bookingId:null,searchRadiusKm:10,scheduledAt:null};
