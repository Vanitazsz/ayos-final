        ...
        {workers.length ? (
          ...
          <View style={styles.emptyState}>
            ...
            <Button
              ...
              fullWidth
              testID="category-book-cta"
              style={styles.bookButton}
              onPress={openRequestForCategory}
            />
=======
  ...
  const workers = useMemo(() => 
    providers.filter(worker => worker.category.toLowerCase().includes(categoryName)), 
  [categoryName, providers]);
  ...
  return (
    <Screen safeArea scrollable backgroundColor={theme.colors.background}>
      <View style={[styles.header, { paddingHorizontal: theme.layout.screenPadding }]}>
        ...
        <Text style={[theme.typography.h3, { color: theme.colors.textPrimary }]}>{title} Experts</Text>
        <View style={{ width: 40 }} />
      </View>
