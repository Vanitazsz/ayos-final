        ...
        <View style={styles.reviewFooter}>
          ...
          >
            <ThumbsUp
              size={14}
              color={
                likedReviews.has(item.id) ? Colors.cta : Colors.textTertiary
              }
              fill={likedReviews.has(item.id) ? Colors.cta : 'transparent'}
              strokeWidth={2}
            />
            <AppText
              variant="caption"
        ...
        <View>
          ...
          <View style={styles.summaryCard}>
            <View style={styles.summaryLeft}>
              <AppText variant="h1" weight="bold" color={Colors.cta}>
                {avgRating}
              </AppText>
