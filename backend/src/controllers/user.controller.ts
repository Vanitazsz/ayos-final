...
export const userController = {
  me: async (request: Request, response: Response) =>
    sendSuccess(response, await userService.me(request.auth!.userId)),
  ...
  addresses: async (request: Request, response: Response) =>
    sendSuccess(
      response,
      await userService.listAddresses(
        request.auth!.userId,
  ...
  createAddress: async (request: Request, response: Response) =>
    sendSuccess(
      response,
      await userService.createAddress(request.auth!.userId, request.body),
      'Address created',
      201,
    ),
  ...
  setLocation: async (request: Request, response: Response) =>
    sendSuccess(
      response,
      await userService.setLocation(request.auth!.userId, request.body),
      'Location saved',
    ),
  consent: async (request: Request, response: Response) =>
    sendSuccess(
      response,
      await userService.recordConsent(request.auth!.userId, request.body, request.ip),
      'Consent recorded',
      201,
    ),
  settings: async (request: Request, response: Response) =>
    sendSuccess(response, await userService.settings(request.auth!.userId)),
  updateSettings: async (request: Request, response: Response) =>
    sendSuccess(
      response,
      await userService.updateSettings(request.auth!.userId, request.body),
      'Settings updated',
    ),
  favorites: async (request: Request, response: Response) =>
    sendSuccess(response, await userService.listFavorites(request.auth!.userId)),
  addFavorite: async (request: Request, response: Response) =>
    sendSuccess(
      response,
      await userService.addFavorite(request.auth!.userId, String(request.params.providerId)),
      'Favorite added',
      201,
    ),
  ...
  identity: async (request: Request, response: Response) =>
    sendSuccess(
      response,
      await userService.addIdentityDocument(request.auth!.userId, request.body),
